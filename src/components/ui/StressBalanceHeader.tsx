...
export function StressBalanceHeader({ ctl, atl, tsb }: StressBalanceHeaderProps) {
  const getStatus = () => {
    ...
    return { label: 'Optimal', color: 'text-green-600', bg: 'bg-green-50', icon: Minus };
  };
  ...
  return (
    <div className="bg-white border border-slate-200 p-4 sm:p-5 mb-4 sm:mb-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className={`${status.bg} p-3`}>
